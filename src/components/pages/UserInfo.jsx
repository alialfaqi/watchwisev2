...
function UserInfo() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toast.success(
        `your changes have been saved ${cookies.User.first_name}!`,
        {
          position: "top-right",
          autoClose: 2000,
  ...
  return (
    <div className="flex relative justify-center items-center bg-gray-100 mt-[65px]">
      ...
      >
        ...
        <div
          className="mb-4 max-w-[120px] mx-auto relative"
        ...
        >
          ...
          {isImageMenuVisible ? (
            <ul
              className="bg-white absolute top-[80px] left-[-60px] border rounded-md min-w-[150px]"
              onClick={toggleImageMenu}
            >
              ...
              <li
                className="hover:bg-gray-100 relative z-10 cursor-pointer border-b-2 p-1"
                onClick={uploudNewPhoto}
              >
                new photo
              </li>
              <li
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            defaultValue={`${cookies.User.bio ? cookies.User.bio : ""}`}
            className="bg-gray-100 focus:bg-white w-full px-3 py-2 border rounded-md focus:outline-none  focus:border-secondary transition-colors"
          />
          {errors.bio && (
            <span className="text-red-500">This field is required</span>
        ...
        >
          {loadingStatue ? (
            <div role="status">
              <svg
                aria-hidden="true"
                className="inline w-6 h-6 mr-2 text-gray-100 animate-spin dark:text-gray-400 fill-text1"
                viewBox="0 0 100 101"
                fill="none"
